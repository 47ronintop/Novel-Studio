...
| TD-013 | `CODING_STANDARDS.md` 第3/4/5节 | 具体 monorepo、tsconfig、ESLint、Prettier、schema codegen 配置文件尚未创建 | Phase 7 前无法执行自动门禁 | Phase 6 拆分工具链初始化任务 | Open |
| TD-014 | `CODING_STANDARDS.md` 第6节 | dependency boundary 检查工具尚未选型 | 分层规则可能只能靠人工审查 | Phase 6 评估 ESLint boundaries 或 dependency graph 工具 | Open |
