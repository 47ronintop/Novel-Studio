...
| TD-017 | `ROADMAP.md` M2/M3                                       | JSON Schema 已落地，但 schema codegen 工具和 dependency boundary 工具仍需最终选择                 | TypeScript 类型仍未由 Schema 自动派生；分层检查仍偏基础 | Phase 7 M3 前评估 schema codegen；M3/M7 前强化 dependency boundaries  | Open   |
