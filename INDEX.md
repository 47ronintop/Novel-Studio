...
| Phase 7 正式开发      | In Progress | M0-M8 已完成：Repository Baseline、Toolchain、Schema、Repository Core、Desktop Shell、Editor UX、LLM Adapter、Agent/Context/Workflow、Studio and Settings | schema codegen、dependency boundary 工具待后续硬化                           | 执行 M9 Hardening and Alpha |
