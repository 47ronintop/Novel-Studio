...
Version: 1.7 | Last Updated: 2026-07-03
...
| Phase 7 正式开发      | In Progress | M0 文档基线已提交并发布；M1 Toolchain Foundation 已完成           | schema codegen、dependency boundary 工具待选择                               | 执行 M2 Schema Foundation |
